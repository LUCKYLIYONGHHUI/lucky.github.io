...
# 数据表名称: goods
engine = create_engine('mysql+pymysql://root:mysql@127.0.0.1/jing dong')
pd.read sql('goods', engine)
```
...
```python
engine = create_engine('mysql+pymysql://root:mysq1@127.0.0.1/jing dong')
